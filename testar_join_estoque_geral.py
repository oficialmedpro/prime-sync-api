...
# -*- coding: utf-8 -*-
"""
Teste para verificar JOIN com ESTOQUE_GERAL
"""
...
def testar_join_estoque_geral():
    """Testa JOIN com ESTOQUE_GERAL"""
    ...
    try:
        ...
        # Testar JOIN com ESTOQUE_GERAL
        logger.info("🔍 Testando JOIN com ESTOQUE_GERAL...")
        cursor.execute("""
            SELECT
                A3.CODIGO_ATEND_A1,
                A3.NUMEROFORMULA,
        ...
        for i, row in enumerate(registros, 1):
            ...
            logger.info(f"  - NOMEPRODUTO: '{row[4]}'")
        ...
        cursor.execute("""
            ...
            AND EG.NOMEPRODUTO IS NOT NULL
        """)
