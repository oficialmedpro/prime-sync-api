...
DECLARE
  ...
  v_url text;
BEGIN
  -- Tentar primeiro endpoint: beta.oficialmed.com.br
  v_url := 'https://beta.oficialmed.com.br/sync';
  ...
  BEGIN
    ...
    IF v_response.status = 200 THEN
      RAISE NOTICE 'Sincronização bem-sucedida via beta.oficialmed.com.br';
      RETURN v_response.content::json;
    END IF;

  EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Falha em beta.oficialmed.com.br: %. Tentando bi...', SQLERRM;
  END;

  -- Fallback: tentar segundo endpoint bi.oficialmed.com.br
  v_url := 'https://bi.oficialmed.com.br/sync';
  ...
  BEGIN
    ...
    -- Se status 200, sucesso!
    IF v_response.status = 200 THEN
      RAISE NOTICE 'Sincronização bem-sucedida via bi.oficialmed.com.br';
      RETURN v_response.content::json;
    END IF;

  EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'Falha em bi.oficialmed.com.br: %', SQLERRM;
  END;
