...
logger.info(f"FIREBIRD_PASS: {'***' if FIREBIRD_PASS else 'VAZIO'} (length: {len(FIREBIRD_PASS) if FIREBIRD_PASS else 0})")
logger.info(f"FIREBIRD_PASS repr: {repr(FIREBIRD_PASS)}")
